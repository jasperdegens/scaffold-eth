...
import "./App.css";
import { useUserProvider, useGasPrice, useContractLoader, useContractReader, useEventListener, useBalance, useExternalContractLoader } from "./hooks";
        ...
        <Switch>
          <Route exact path="/">
            ...
            */}
            ...
            <Contract
              name="YourContract"
              signer={!userProvider ? undefined : userProvider.getSigner()}
